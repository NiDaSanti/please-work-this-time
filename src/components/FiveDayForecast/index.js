...
const FiveDayForecast = (props) => (
    <div className = "five-day-container">
        <div className = "first-day-container">
            {props.currentDate && <p className = "current-time"><Moment format = 'MMM Do YYYY' withTitle>{props.currentDate}</Moment></p>}
        ...
        <div className = "second-day-container">
            {props.currentDate2 && <p className = "current-time"><Moment format = 'MMM Do YYYY' withTitle>{props.currentDate2}</Moment></p>}
        ...
        <div className = "third-day-container">
            {props.currentDate3 && <p className = "current-time"><Moment format = 'MMM Do YYYY' withTitle>{props.currentDate3}</Moment></p>}
        ...
        <div className = "fourth-day-container">
            {props.currentDate4 && <p className = "current-time"><Moment format = 'MMM Do YYYY' withTitle>{props.currentDate4}</Moment></p>}
        ...
        <div className = "fifth-day-container">
            {props.currentDate5 && <p className = "current-time"><Moment format = 'MMM Do YYYY' withTitle>{props.currentDate5}</Moment></p>}
